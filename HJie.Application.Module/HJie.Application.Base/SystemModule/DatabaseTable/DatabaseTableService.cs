using HJie.DataBase.Repository;
using HJie.Util;
using System;
...
namespace HJie.Application.Base.SystemModule.DatabaseTable
{
    ...
    public class DatabaseTableService : RepositoryFactory
    {
        ...
        /// <returns></returns>
        public IEnumerable<DatabaseTableModel> GetTableList(string conString)
        {
            try
            {
                ...
                //}
                return this.BaseRepository(conString, "Oracle").GetDBTable<DatabaseTableModel>();
            }
            catch (Exception ex)
            {
